...
RcppExport SEXP gwfa_gwfa_c(SEXP pt_xSEXP, SEXP pt_ySEXP, SEXP coord_xSEXP, SEXP coord_ySEXP, SEXP bandwithSEXP, SEXP taille_sampleSEXP, SEXP rayonsSEXP, SEXP qsSEXP) {
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(gwfa_c(pt_x, pt_y, coord_x, coord_y, bandwith, taille_sample, rayons, qs));
    return __result;
END_RCPP
}
